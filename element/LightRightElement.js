class LightRightElement extends TetrisElement {
    constructor(x=-2, y=5, color, nowstatus) {
        ...
        this.status = [
            ...
            [{ offsetX: 2, offsetY: 0 }, { offsetX: 2, offsetY: 1 }, { offsetX: 2, offsetY: 2 }, { offsetX: 1, offsetY: 2 }],
            [{ offsetX: 0, offsetY: 0 }, { offsetX: 0, offsetY: 1 }, { offsetX: 1, offsetY: 1 }, { offsetX: 2, offsetY: 1 }],
            [{ offsetX: 1, offsetY: 0 }, { offsetX: 2, offsetY: 0 }, { offsetX: 1, offsetY: 1 }, { offsetX: 1, offsetY: 2 }]
        ];
        for (let i = 0; i < 4; i++) {
